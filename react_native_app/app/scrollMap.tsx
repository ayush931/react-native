...
function ScrollMap() {
  return (
    <View>
      <FlatList
        data={[
          1, 2, 3, 4, 5, 6, 7, 8, 9, 1, 4, 3, 4, 5, 4, 2, 4, 5, 2, 3, 3, 4, 2, 3, 1, 2, 3, 4, 5, 6,
          7, 8, 9, 1, 4, 3, 4, 5, 4, 2, 4, 5, 2, 3, 3, 4, 2, 3,
        ]}
        // horizontal
        ...
        ListFooterComponent={
          <View style={{ width: "100%", height: 200, backgroundColor: "yellow" }}></View>
        }
        renderItem={({ item }) => {
          return (
            <View
